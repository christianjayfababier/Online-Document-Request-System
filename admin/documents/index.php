                ...
                <div class="row justify-content-center" >
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                               ...
                               <?php foreach ($cstudent as $row): ?>
                                <div class="d-inline-block">
                                    ...
                                    <h2 class="mb-0"><?= $row['count_students'] + $row['count_hs']; ?></h2>
                                </div>
                            ...
                            <div class="row">
                            <a href="highschool.php" class="btn btn-primary col-6" style="background-color:#1269AF">View Highchool</a>
                            <a href="student.php" class="btn btn-primary col-6" style="background-color:#1269AF">View College</a>
                        </div></div>
                    </div>
                </div>
                <div class="row justify-content-center" >
