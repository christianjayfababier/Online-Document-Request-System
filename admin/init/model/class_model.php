...
<?php
	...
	class class_model{
	    ...
	    public function fetchAll_documentrequest(){ 
            $sql = "SELECT * FROM  tbl_documentrequest ORDER BY time_stamp DESC";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
	   ...
	   public function delete_user($user_id){
	    ...
	    public function count_numberofstudents(){ 
		  ...
		  public function count_allstudents(){ 
            $sql = "SELECT (SELECT COUNT(student_id)  FROM tbl_student) as count_students, (SELECT COUNT(student_id)  FROM tbl_high_school) as count_hs ";
				$stmt = $this->conn->prepare($sql); 
				$stmt->execute();
				$result = $stmt->get_result();
		        $data = array();
